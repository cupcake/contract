...
#[derive(Accounts)]
pub struct ClaimSprinkle<'info> {
  /// The account which receives the tokens from the Sprinkle claim
  ...
  #[account(mut)]
  pub bakery: Box<Account<'info, Bakery>>,

  /// The authority account for this Sprinkle
